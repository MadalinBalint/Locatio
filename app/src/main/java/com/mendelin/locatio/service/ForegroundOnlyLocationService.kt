package com.mendelin.locatio.service
...
class ForegroundOnlyLocationService : Service() {
    ...
    private fun generateNotification(location: Location?): Notification {
        ...
        val mainNotificationText =
            location.toString() //location?.toText() ?: getString(R.string.no_location_text)
        ...
        return notificationCompatBuilder
            ...
            .addAction(
                ...
                /*getString(R.string.stop_location_updates_button_text)*/"Stop updates",
    ...
    companion object {
        private const val PACKAGE_NAME = "com.mendelin.locatio"
